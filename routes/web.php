...
/* Homepage */
Route::get('/', 'UserCredentialController@home')->name('credential.home');

/* Route::get('/example', 'UserCredentialController@example')->name('credential.example');

/* Show all credentials for hospital */
Route::get('/user-credentials', 'UserCredentialController@userCredentialList')->name('userCredential.showCredentialList');

/*Adding new hospital to credential list*/
Route::get('/user-credentials/add', 'UserCredentialController@addNewCredentialForm')->name('credential.addNewCredentialForm');
Route::post('/user-credentials/', 'UserCredentialController@addNewCredential')->name('credential.addNewCredential');

/* Edit credential status for user */
Route::get('/user-credentials/edit', 'UserCredentialController@editUserCredentialForm')->name('credential.editUserCredentialForm');
Route::put('/user-credentials/', 'UserCredentialController@editUserCredential')->name('credential.editUserCredential');

/* Remove hospital from credential list */
Route::get('/user-credentials/delete', 'UserCredentialController@deleteUserCredentialForm')->name('credential.deleteUserCredentialForm');
